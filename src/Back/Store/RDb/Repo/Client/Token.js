/**
 * Repository for managing Client Token in the database.
 * @implements TeqFw_Db_Back_Api_RDb_Repository
 */
export default class Fl64_OAuth2_Back_Store_RDb_Repo_Client_Token {
    /**
     * @param {TeqFw_Db_Back_App_Crud} crud - CRUD engine for database operations.
     * @param {Fl64_OAuth2_Back_Store_RDb_Schema_Client_Token} schema - Persistent DTO schema for Client Token.
     */
    constructor(
        {
            TeqFw_Db_Back_App_Crud$: crud,
            Fl64_OAuth2_Back_Store_RDb_Schema_Client_Token$: schema
        }
    ) {
        /**
         * @param {Fl64_OAuth2_Back_Store_RDb_Schema_Client_Token.Dto} [dto]
         * @returns {Fl64_OAuth2_Back_Store_RDb_Schema_Client_Token.Dto}
         */
         ...
         * @param {Fl64_OAuth2_Back_Store_RDb_Schema_Client_Token.Dto} [params.dto]
        ...
        /**
         * @returns {Fl64_OAuth2_Back_Store_RDb_Schema_Client_Token}
         */
         ...
         * @returns {Promise<{records: Array<Fl64_OAuth2_Back_Store_RDb_Schema_Client_Token.Dto>}>}
         */
         ...
         * @returns {Promise<{record: Fl64_OAuth2_Back_Store_RDb_Schema_Client_Token.Dto|null}>}
         */
